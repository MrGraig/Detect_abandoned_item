...
def detect_abandoned_item(video_file):
    ...
    while True:
        ...
        _, thresh_diff = cv2.threshold(frame_diff, 30, 255, cv2.THRESH_BINARY)  # применение порога разницы
        ...
        for contour in contours:
            ...
            if area > 3000:
                ...
                if coordinates in dict_of_coord:
                    ...
                    dict_of_coord[coordinates] = 1
                if dict_of_coord[coordinates] > 100:  # координаты объекта остаются неизменными на протяжении более 100 кадров
